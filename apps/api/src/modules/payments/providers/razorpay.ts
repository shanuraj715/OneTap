...
export const razorpayProvider: PaymentProvider = {
  ...
  async createIntent(creds: GatewayCredentials, input: CreateIntentInput): Promise<PaymentIntent> {
  ...
  async verify(creds: GatewayCredentials, input: VerifyInput): Promise<VerifyResult> {
  ...
  async parseWebhook(creds: GatewayCredentials, input: WebhookInput): Promise<WebhookResult> {
