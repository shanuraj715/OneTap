...
import { formatINR, type Menu as MenuType, type MenuItem } from "@onetap/config-schema";
import {
  Minus,
  NotepadText,
  Phone,
...
import type { AdminOrder, Outlet } from "../../lib/api";
...
interface DraftLine {
  ...
  quantity: number;
  note?: string;
  /** true for lines already on the order, false for ones being added now */
  existing: boolean;
}
...
const body: CSSProperties = { padding: "16px 20px", overflowY: "auto", flex: 1 };
