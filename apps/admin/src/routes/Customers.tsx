...
const LEDGER_LABEL: Record<WalletLedgerEntry["kind"], string> = {
  earn: "Earned",
  redeem: "Redeemed",
  reverse: "Refunded",
};
...
function WalletLedger({ customerId }: { customerId: string }) {
  const { outlet } = useOutlet();
...
const ledgerCoins: CSSProperties = {
