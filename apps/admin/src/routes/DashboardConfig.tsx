...
const CATEGORY_LABEL = { stat: "Stat card", chart: "Chart", list: "List" } as const;
const CATEGORY_ICON = { stat: LayoutGrid, chart: BarChart3, list: ListTree } as const;
...
export function DashboardConfig() {
  ...
  const setWidget = (index: number, patchValue: Partial<DashboardWidgetSettings>) => {
    const next = [...widgets];
...
const reorderCol: CSSProperties = { display: "flex", flexDirection: "column", gap: 2 };
...
const roleGrid: CSSProperties = { display: "flex", flexWrap: "wrap", gap: 6, flex: "1 1 260px" };
...
const roleChipActive: CSSProperties = {
