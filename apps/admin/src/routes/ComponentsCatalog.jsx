...
const FALLBACK_ITEMS = [
  {
    ...
    foodType: "veg",
    tags: ["bestseller"],
    images: [{ url: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b9?w=400&auto=format&fit=crop&q=80" }],
    description: "Delicate steamed dumplings with minced cabbage, carrots & mild spices",
    isAvailable: true,
    variants: [
      { id: "v1", name: "6 pcs", label: "6 pcs", price: 120 },
      { id: "v2", name: "10 pcs", label: "10 pcs", price: 180 },
    ],
  },
  {
    id: "sample-2",
    ...
    foodType: "veg",
    tags: ["spicy"],
    images: [{ url: "https://images.unsplash.com/photo-1541696432-82c6da8ce7bf?w=400&auto=format&fit=crop&q=80" }],
  ...
  },
  {
    ...
    foodType: "veg",
    tags: [],
    images: [{ url: "https://images.unsplash.com/photo-1589302168068-964664d93dc0?w=400&auto=format&fit=crop&q=80" }],
