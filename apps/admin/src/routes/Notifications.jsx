...
const hint                = { fontSize: 12.5, color: "var(--color-text-muted)" };
const eventChip                = {
  fontSize: 12.5,
  fontWeight: 600,
  padding: "6px 12px",
