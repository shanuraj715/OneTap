...
export function JobQueue({ outlet, canPrint }                                       ) {
  ...
  const error = (retry.error ?? reprint.error ?? cancel.error)                ;
...
const btn                = { fontSize: 12.5, padding: "6px 12px", display: "inline-flex", alignItems: "center", gap: 6 };
const chip                = {
  font: "inherit",
  fontSize: 12.5,
  fontWeight: 600,
