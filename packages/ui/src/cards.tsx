...
const dim = (item: MenuItem): CSSProperties => ({ opacity: item.isAvailable ? 1 : 0.55 });

/* 1 ─ compact row, no image */
export function RowCompact({ item }: ItemCardProps) {
  return (
...
export function RowThumbLeft({ item }: ItemCardProps) {
  return (
...
export function RowThumbRight({ item }: ItemCardProps) {
  return (
    <article style={{ ...cardBase, ...dim(item), display: "flex", gap: 14, padding: 12 }}>
      <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column", justifyContent: "center" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 2 }}>
...
export function ImageTop({ item }: ItemCardProps) {
  return (
...
export function ImageTopBadge({ item }: ItemCardProps) {
  return (
    <article style={{ ...cardBase, ...dim(item), display: "flex", flexDirection: "column" }}>
...
export function TextAboveImage({ item }: ItemCardProps) {
  return (
    <article style={{ ...cardBase, ...dim(item), display: "flex", flexDirection: "column" }}>
...
export function ImageOverlay({ item }: ItemCardProps) {
  return (
...
export function Portrait({ item }: ItemCardProps) {
  return (
    <article style={{ ...cardBase, ...dim(item), display: "flex", flexDirection: "column" }}>
...
export function Circle({ item }: ItemCardProps) {
  return (
    <article
      style={{
        ...cardBase,
...
export function MenuLine({ item }: ItemCardProps) {
  return (
...
export function FeaturedWide({ item }: ItemCardProps) {
  return (
