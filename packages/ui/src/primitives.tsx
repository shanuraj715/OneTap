...
import { itemPriceLabel, type FoodType, type MenuItem } from "@onetap/config-schema";
...
export function VariantLine({ item }: { item: MenuItem }) {
...
export const variantLineStyle: CSSProperties = {
  fontSize: 12,
  color: "var(--color-text-muted)",
  marginTop: 6,
};
