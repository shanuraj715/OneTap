...
export interface FooterProps {
  ...
  address?: string;
  phone?: string;
  /** 14-digit FSSAI licence number — legally required on the storefront */
  fssaiLicense?: string;
  gstin?: string;
  hours?: string;
}
...
const inner: CSSProperties = { maxWidth: 1080, margin: "0 auto", padding: "28px 24px", fontSize: 13 };
...
const muted: CSSProperties = { color: "var(--color-text-muted)", lineHeight: 1.7 };
...
function Licences({ fssaiLicense, gstin }: Pick<FooterProps, "fssaiLicense" | "gstin">): ReactNode {
  return (
    <>
...
export function FooterTwoColumn(p: FooterProps) {
  return (
    <footer style={shell}>
...
export function FooterCentered(p: FooterProps) {
  return (
    <footer style={shell}>
...
/* 3 ─ three columns */
export function FooterColumns(p: FooterProps) {
  return (
    <footer style={shell}>
      <div
        style={{
...
export function FooterMinimalBar(p: FooterProps) {
...
export function FooterBrandBlock(p: FooterProps) {
  return (
    <footer style={shell}>
      <div style={inner}>
...
/* 6 ─ inverted bar */
export function FooterInverted(p: FooterProps) {
  return (
...
export function FooterContact(p: FooterProps) {
  return (
    <footer style={shell}>
...
export function FooterNewsletter(p: FooterProps) {
  return (
    <footer style={shell}>
