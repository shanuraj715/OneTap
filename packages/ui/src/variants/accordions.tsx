...
const a: CSSProperties = { fontSize: "0.87rem", color: "var(--color-text-muted)", lineHeight: 1.55, marginTop: 8 };
...
export function AccordionBordered({ items }: AccordionProps) {
...
export function AccordionCards({ items }: AccordionProps) {
  const { isOpen, toggle } = useAccordion();
  return (
...
export function AccordionMinimal({ items }: AccordionProps) {
  const { isOpen, toggle } = useAccordion();
  return (
    <div>
      {items.map((it, i) => (
...
export function AccordionPlus({ items }: AccordionProps) {
  const { isOpen, toggle } = useAccordion();
  return (
    <div style={{ border: "1px solid var(--color-border)", borderRadius: 10, overflow: "hidden" }}>
      {items.map((it, i) => (
...
export function AccordionFilled({ items }: AccordionProps) {
  const { isOpen, toggle } = useAccordion();
  return (
...
export function AccordionAccent({ items }: AccordionProps) {
  const { isOpen, toggle } = useAccordion();
  return (
...
/** 07 numbered rows */
export function AccordionNumbered({ items }: AccordionProps) {
  const { isOpen, toggle } = useAccordion();
  return (
    <div>
      {items.map((it, i) => (
...
export function AccordionMulti({ items }: AccordionProps) {
