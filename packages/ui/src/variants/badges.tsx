...
import { toneVars, type BadgeProps } from "./types";
...
/** 04 pill */
export function BadgePill({ children, tone }: BadgeProps) {
  const t = toneVars(tone);
...
export function BadgeDot({ children, tone }: BadgeProps) {
  const t = toneVars(tone);
  return (
...
/** 06 left accent bar */
export function BadgeAccent({ children, tone }: BadgeProps) {
  const t = toneVars(tone);
  return (
...
export function BadgeMicro({ children, tone }: BadgeProps) {
  const t = toneVars(tone);
  return (
...
export function BadgeBrand({ children }: BadgeProps) {
  return (
