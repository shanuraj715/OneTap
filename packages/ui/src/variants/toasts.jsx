...
const close                = { marginLeft: "auto", opacity: 0.5, fontSize: "1.05rem", lineHeight: 1, cursor: "pointer" };

/** 01 solid tone, elevated */
export function ToastSolid({ title, message, tone = "info" }            ) {
...
export function ToastCard({ title, message, tone = "info" }            ) {
  const t = toneVars(tone);
  return (
...
export function ToastStripe({ title, message, tone = "info" }            ) {
  const t = toneVars(tone);
  return (
...
/** 04 soft wash */
export function ToastSoft({ title, message, tone = "info" }            ) {
  const t = toneVars(tone);
  return (
...
/** 05 pill, single line */
export function ToastPill({ title, message, tone = "info" }            ) {
  const t = toneVars(tone);
  return (
...
export function ToastTimer({ title, message, tone = "info" }            ) {
  const t = toneVars(tone);
  return (
...
export function ToastMinimal({ title, message, tone = "info" }            ) {
  const t = toneVars(tone);
  return (
