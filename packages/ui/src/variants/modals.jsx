...
const bodyText                = { fontSize: "0.88rem", color: "var(--color-text-muted)", lineHeight: 1.55, margin: "8px 0 0" };
const actions                = { display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 20 };
const primary                = {
  font: "inherit",
  fontSize: "0.85rem",
  fontWeight: 600,
...
const secondary                = { ...primary, background: "transparent", color: "var(--color-text-muted)", border: "1px solid var(--color-border)" };
...
const Body = ({ children }                         ) => <p style={bodyText}>{children}</p>;

/** 01 centred card */
export function ModalCentered({ title: t, children, onClose }            ) {
  return (
...
export function ModalHeaderBar({ title: t, children, onClose }            ) {
  return (
...
export function ModalSheet({ title: t, children, onClose }            ) {
  return (
...
/** 04 side drawer */
export function ModalDrawer({ title: t, children, onClose }            ) {
  return (
...
/** 05 compact confirm */
export function ModalConfirm({ title: t, children, onClose }            ) {
  return (
...
/** 06 top accent rule */
export function ModalAccent({ title: t, children, onClose }            ) {
  return (
...
export function ModalDivided({ title: t, children, onClose }            ) {
  return (
    <div className="ot-anim-pop" style={{ ...shell, borderRadius: 12, overflow: "hidden" }} role="dialog" aria-label={t}>
...
export function ModalElevated({ title: t, children, onClose }            ) {
  return (
