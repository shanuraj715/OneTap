...
import type { AccordionProps as FaqProps } from "./types";
...
const qStyle: CSSProperties = { fontWeight: 600, fontSize: "0.94rem", color: "var(--color-text)" };
const aStyle: CSSProperties = { fontSize: "0.87rem", color: "var(--color-text-muted)", lineHeight: 1.6 };

/** 01 stacked, all answers visible */
export function FaqStacked({ items }: FaqProps) {
  return (
    <section>
...
/** 02 two columns */
export function FaqTwoColumn({ items }: FaqProps) {
  return (
    <section>
      <h2 style={heading}>Frequently asked</h2>
...
export function FaqSplit({ items }: FaqProps) {
  return (
...
export function FaqCards({ items }: FaqProps) {
  return (
    <section>
      <h2 style={heading}>Frequently asked</h2>
...
export function FaqCollapsible({ items }: FaqProps) {
...
/** 06 numbered list */
export function FaqNumbered({ items }: FaqProps) {
  return (
    <section>
      <h2 style={heading}>Frequently asked</h2>
...
export function FaqCentered({ items }: FaqProps) {
  return (
