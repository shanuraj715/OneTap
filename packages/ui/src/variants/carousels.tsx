...
const frame: CSSProperties = { position: "relative", borderRadius: "var(--radius-card)", overflow: "hidden", border: "1px solid var(--color-border)", transition: "transform var(--motion-base) var(--ease-out), opacity var(--motion-base) var(--ease-out)" };
const caption: CSSProperties = { fontWeight: 600, fontSize: "0.95rem", color: "var(--color-text)" };
const sub: CSSProperties = { fontSize: "0.8rem", color: "var(--color-text-muted)" };
...
export function CarouselStrip({ items }: CarouselProps) {
  return (
...
export function CarouselPeek({ items }: CarouselProps) {
...
export function CarouselThumbs({ items }: CarouselProps) {
...
export function CarouselQuotes({ items }: CarouselProps) {
...
export function CarouselHero({ items }: CarouselProps) {
  const { i, next, prev } = useCarousel(items.length);
  const item = items[i]!;
  return (
...
export function CarouselStack({ items }: CarouselProps) {
