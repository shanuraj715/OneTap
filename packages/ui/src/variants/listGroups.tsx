...
const title: CSSProperties = { fontWeight: 600, fontSize: "0.9rem", color: "var(--color-text)" };
const meta: CSSProperties = { fontSize: "0.78rem", color: "var(--color-text-muted)" };
const rowBase: CSSProperties = { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 };

/** 01 bordered box, divided rows */
export function ListBordered({ items }: ListGroupProps) {
  return (
...
/** 02 separate cards */
export function ListCards({ items }: ListGroupProps) {
  return (
...
export function ListFlush({ items }: ListGroupProps) {
  return (
...
/** 04 numbered */
export function ListNumbered({ items }: ListGroupProps) {
  return (
...
export function ListAccent({ items }: ListGroupProps) {
  return (
...
export function ListStacked({ items }: ListGroupProps) {
  return (
    <ul style={{ listStyle: "none", margin: 0, padding: 0, border: "1px solid var(--color-border)", borderRadius: 10, overflow: "hidden" }}>
      {items.map((it, i) => (
...
/** 07 striped rows */
export function ListStriped({ items }: ListGroupProps) {
  return (
...
export function ListChevron({ items }: ListGroupProps) {
  return (
    <ul style={{ listStyle: "none", margin: 0, padding: 0, border: "1px solid var(--color-border)", borderRadius: 10, overflow: "hidden" }}>
      {items.map((it, i) => (
