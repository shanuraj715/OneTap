...
const body                = { fontSize: "0.86rem", color: "var(--color-text-muted)", lineHeight: 1.5, margin: 0 };
const tagStyle                = {
  fontSize: "0.66rem",
  fontWeight: 700,
...
export function ContentImageTop({ title, body: text, tag, imageSeed }                  ) {
  return (
...
/** 02 no photo, quiet */
export function ContentPlain({ title, body: text, tag }                  ) {
  return (
...
export function ContentHorizontal({ title, body: text, tag, imageSeed }                  ) {
  return (
...
export function ContentOverlay({ title, body: text, tag, imageSeed }                  ) {
  return (
...
/** 05 top accent rule */
export function ContentTopAccent({ title, body: text, tag }                  ) {
  return (
...
export function ContentOffset({ title, body: text, tag }                  ) {
  return (
...
export function ContentElevated({ title, body: text, tag, imageSeed }                  ) {
  return (
...
export function ContentEditorial({ title, body: text, tag }                  ) {
  return (
