...
function Remove({ show, onRemove }: { show?: boolean; onRemove?: () => void }) {
...
export function ChipSolid({ children, selected, removable, onRemove }: ChipProps) {
  return (
...
export function ChipSoft({ children, selected, removable, onRemove }: ChipProps) {
  return (
...
/** 03 square corners */
export function ChipSquare({ children, selected, removable, onRemove }: ChipProps) {
  return (
...
export function ChipTick({ children, selected, removable, onRemove }: ChipProps) {
  return (
...
export function ChipFilled({ children, selected, removable, onRemove }: ChipProps) {
  return (
...
export function ChipUnderline({ children, selected, removable, onRemove }: ChipProps) {
  return (
...
export function ChipCompact({ children, selected, removable, onRemove }: ChipProps) {
  return (
...
/** 08 leading dot */
export function ChipDot({ children, selected, removable, onRemove }: ChipProps) {
  return (
